...
function Brief() {
    return (
        <div className="w-full h-auto flex flex-col md:flex-row justify-between items-baseline px-4 md:px-12 py-10 mb-4 z-10">
            ...
            <div className="w-full lg:w-1/3 mb-4 md:mb-0">
                <MotionTextWrapper delay={2}>
                    <span className="text-AAprimary font-Text2 text-xl lg:text-2xl rounded-md md:pl-12 lg:pl-0 ">
            ...
            <div className="hidden lg:block md:w-1/2 lg:w-1/3">
                ...
                <MotionTextWrapper delay={2}>
                    <span className="text-AAprimary font-Text2 text-sm sm:text-base md:text-md lg:text-2xl">
